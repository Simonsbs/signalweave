...
- BasicProp-style desktop shell with:
  ...
  - `SimControl.checkPatternsAvailable()`-style mixed feedback routing: BasicProp-style `Note:` message output for uninitialized patterns and a `No can do!` modal for zero loaded patterns
