...
public static class BasicPropNetworkConfigParser
{
    ...
    public static NetworkDefinition Parse(string text, string? fallbackName = null)
    {
        ...
        var definition = new NetworkDefinition
        {
            ...
            SecondHiddenUnits = ReadInt(values, ["secondhiddenunits", "hidden2", "hiddenlayer2", "layer2units"], 0),
            ...
            UseSecondHiddenBias = ReadBool(values, ["usesecondhiddenbias", "secondhiddenbias", "hidden2bias", "layer2bias"], false),
...
public static class BasicPropNetworkConfigWriter
{
    public static string Write(NetworkDefinition definition)
    {
        ...
        return string.Join(
            ...
            $"hidden2 = {definition.SecondHiddenUnits.ToString(CultureInfo.InvariantCulture)}",
            ...
            $"hidden2Bias = {FormatBool(definition.UseSecondHiddenBias)}",
